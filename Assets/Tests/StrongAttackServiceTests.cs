...
namespace Tests
{
    public class StrongAttackServiceTests
    {
        ...
        public void Setup()
        {
            _service = new StrongAttackService();
        }

        [TestCase(12, 40f, 10, 0, 50f)]
        public void Execute_AppliesCorrectDamageAndSetsCooldown(int atkAttacker, float hpAttacker, int defenseAttacker,
            int defenseTarget, float hpTarget)
        {
            // arrange
            ...
            // 50 - 12 * 1.8 = 28.4
            // 12 * 1.8 = 21.6
            const float expectedTargetHp = 28.4f;
            const float expectedMp = 30f;
            ...
            Assert.AreEqual(currentTime + 3.0f, attacker.LastActionTime);
        }
        ...
        public void Execute_AppliesCorrectDamageWithMitigation()
        {
            ...
            // Raw damage = 12 * 1.8 = 21.6
            // Final damage = 21.6 * (1-10/100) = 21.6 * .9 = 19.44
            const float expectedHp = 80.56f; // 100 - 19.44
            const float currentTime = 5.0f;
