...
**Objetivo:** Entregar o MVP 1.0 de "Ashes of Balance" (5 Fases, Combate Completo) com Arquitetura Limpa e Testes
Unitários.
...
|               | **S4: Combate Básico**  | **Infraestrutura (Unity)** | **Ataque Básico/Forte (Visual/SFX) e Combate Unidirecional (Player \-\> Inimigo).**                                | **DONE** |
